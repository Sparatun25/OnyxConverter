...
export const LIB = {
    ...
    // ffmpeg.js + воркер размещены локально (/vendor): cross-origin Worker браузер блокирует.
    // А большой ffmpeg-core.wasm (~30 МБ) грузим с CDN — Cloudflare Pages не принимает
    // файлы крупнее 25 МБ. CDN отдаёт .wasm с CORS, воркер у нас свой, поэтому всё работает.
    ffmpeg: "/vendor/ffmpeg/ffmpeg.js",
    ffmpegWorker: "/vendor/ffmpeg/814.ffmpeg.js",
    ffmpegCore: "/vendor/ffmpeg/ffmpeg-core.js",
    ffmpegWasm: "https://cdn.jsdelivr.net/npm/@ffmpeg/core@0.12.6/dist/umd/ffmpeg-core.wasm",
};
